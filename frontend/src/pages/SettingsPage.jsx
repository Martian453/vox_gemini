  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        {/* Language Selection */}
        <div className="mt-8">
          <h3 className="text-lg font-semibold mb-3">Preferred Language</h3>
          <select
            value={language}
